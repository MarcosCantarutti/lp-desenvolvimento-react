  ...
  const cardsContent = [
    {
      ...
      POR QUE INVESTIR?
          • Gera um processo seletivo mais assertivo, pois trabalha com visão global da necessidade do cargo, facilitando a comparação da necessidade do cargo com o perfil do candidato;
          • Gera resultados mais eficazes, menor turnover e redução de despesas com retrabalhos na atração de talentos;
          • Maior objetividade e assertividade;
          • Possibilita maior produtividade, qualidade e chance de crescimento dos selecionados, pois busca a pessoa certa para o lugar certo.`,
    },
    {
      id: uuidv4(),
      ...
      POR QUE INVESTIR?
          • Identifica as áreas mais importantes do negócio;
          • Identifica os pontos fortes e fracos da empresa;
          • Mensura o desempenho da empresa;
          • Identifica o nível de maturidade da organização;
          • Direciona esforços para lugar certo;
          • Dá base para implantação de novos projetos`,
    },
    {
      id: uuidv4(),
      ...
      POR QUE INVESTIR?
          • Clareza nas responsabilidades e autoridades;
          • Coordenação e colaboração eficiente;
          ...
          • Processos definidos estabelecem uma base para a melhoria contínua, através de métricas de desempenho e controle de feedback, a empresa pode avaliar regularmente seus processos e identificar oportunidades de aprimoramento. `,
    },
    {
      id: uuidv4(),
      ...
      POR QUE INVESTIR?
          • Proporciona uma administração competitiva e estimulante, que valoriza o conhecimento, as competências e os desempenhos dos colaboradores;
          • Organiza e padroniza os cargos e o sistema de remuneração das empresas;
          • É instrumento para atração e retenção de talentos;
          • Proporciona senso de justiça e de meritocracia dentro da empresa;
          • Com cargos desenhados e descritos a empresa não fica refém de pessoas específicas;
    ...
    },
    {
      ...
      POR QUE INVESTIR?
          • Desenvolver líderes eficientes;
          • Aumenta a produtividade e motivação;
          • Melhora o clima organizacional;
          • Retém talentos;
          • Aumenta a produtividade;
          • Aumenta a segurança ao realizar atividades;
          • Aumenta a credibilidade da empresa;
          • Possibilita profissionais mais preparados nos cargos
      `,
    },
    {
      id: uuidv4(),
      ...
      POR QUE INVESTIR?
          • Acessa o perfil do colaborador com informações completas e profundas;
          • Em processos seletivos possibilita assertividade na escolha do candidato;
          • Ajuda no processo de desenvolvimento dos colaboradores;
          • Auxilia no desenvolvimento das lideranças;
          • Acessa pontos de melhoria.
          `,
    },
    {
      id: uuidv4(),
      ...
      POR QUE INVESTIR?
          • Proporciona uma administração competitiva e estimulante, que valoriza o conhecimento, as competências e os desempenhos dos colaboradores;
          • Organiza e padroniza o sistema de remuneração das empresas;
          • Organiza e padroniza os cargos da empresa;
          • É instrumento para atração e retenção de talentos;
          • Incentiva o aprimoramento profissional dos colaboradores;
          • Gera para o colaborador a sensação que ele terá uma chance se desenvolver e crescer;
          • Proporciona senso de justiça e de meritocracia dentro da empresa;
          • Com cargos desenhados e descritos a empresa não fica refém de pessoas específicas;
          • Cargos desenhados facilita treinamento de novatos;
          • Aumenta a produtividade`,
    },
    {
      id: uuidv4(),
      ...
      POR QUE INVESTIR?
          • Melhora o desempenho no que de fato importa;
          • Estimula a cultura de feedback e a comunicação na empresa;
          • Avalia o potencial do colaborador;
          • Colaborador terá clareza do que é esperado dele;
          • Gera histórico de desenvolvimento.`,
    },
    {
      id: uuidv4(),
      ...
      POR QUE INVESTIR?
          ...
          • Aumenta a produtividade e da performance;
          • Desenvolve a tratativa para resolução de problemas;
          • Aprimora as tomadas de decisões;
          • Aumenta a gestão do tempo;
          • Maior equilíbrio entre trabalho e vida pessoal, entre outros.
          `,
    },
  ];
  return cardsContent;
